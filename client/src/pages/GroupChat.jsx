...
export default function GroupChat() {
  ...
  useEffect(() => {
    api.get(`/group/${groupId}`)
      .then((res) => { setGroup(res.data.group); setMembers(res.data.members || []); })
      .catch(console.error);
  ...
  return (
    <div className="app-shell">
      ...
      <main
        ...
        style={{ display: 'flex', flexDirection: 'column', height: '100vh', padding: '24px 32px' }}
      >
        {/* Chat header */}
        <div style={{
          display: 'flex', alignItems: 'center', justifyContent: 'space-between',
          paddingBottom: '14px', borderBottom: '1px solid var(--border-subtle)', marginBottom: '18px',
        }}>
          <div>
            <h1 style={{ fontSize: '1.25rem', fontWeight: 800 }}>Group Chat</h1>
            ...
            return (
              ...
              >
                ...
                <div>
                  ...
                  <div
                    className={isMe ? 'chat-bubble--mine' : 'chat-bubble--theirs'}
                    style={{ padding: '10px 15px', fontSize: '0.9rem', lineHeight: 1.45 }}
                  >
                    {msg.text}
                  </div>
                </div>
        ...
        <div style={{ marginTop: '14px', position: 'relative' }}>
          ...
          <form onSubmit={handleSend} style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
            ...
            <input
              ...
              style={{ borderRadius: 'var(--radius-full)', padding: '11px 18px', background: 'var(--bg-card)' }}
            ...
            <button
              ...
              style={{ width: '44px', height: '44px', borderRadius: '50%', padding: 0, flexShrink: 0 }}
            >
              <Send size={17} />
            </button>
          </form>
